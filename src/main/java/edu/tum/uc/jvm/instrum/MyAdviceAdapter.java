...
/**
 * This class is responsible for adding bytecode at the end of a method during
 * instrumentation.
 * 
 * @author alex
 *
...
public class MyAdviceAdapter extends AdviceAdapter {
	 ...
	 * Inserts a delegate call of MainMethodReturned if the method is called
	 * "main".
	 * 
	 * @param opcode
	...
	protected void onMethodEnter() {
		if (this.methodName.equals("main")) {// &&
												// !MyUcTransformer.ingestrument_webservice)
												// {
			mv.visitMethodInsn(Opcodes.INVOKESTATIC, MyUcTransformer.DELEGATECLASS, "mainMethodInvoked", "()V", false);
		}
	}
}
